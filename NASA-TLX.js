...
left[1]   = "小さい";
right[1]  = "大きい";
def[1]    = "<p>どの程度の身体的活動(身体を動かす、傾けるなど)を必要としましたか。<br>作業はラクでしたか。それともキツかったですか。<br>ゆっくりできましたか。それともキビキビやらなければなりませんでしたか。<br>休み休みできましたか。それとも働きづめでしたか。</p>";

scale[2]  = "タイムプレッシャー"; 
left[2]   = "弱い";
right[2]  = "強い";
def[2]    = "<p>制限時間や課題が発生する頻度などのために感じる時間的切迫感はどの程度でしたか。<br>ペースはゆっくりとして余裕があるものでしたか。それとも速くて余裕のないものでしたか。</p>";

scale[3]  = "作業成績"; 
left[3]   = "良い";
right[3]  = "悪い";
def[3]    = "<p>指示者によって設定された課題の目標をどの程度達成できたと思いますか。<br>目標の達成に関して自分の作業成績にどの程度満足していますか。</p>";

scale[4]  = "努力"; 
left[4]   = "少ない";
right[4]  = "多い";
def[4]    = "<p>傾きの改善を維持するために、精神的・身体的にどの程度一生懸命に作業しなければなりませんでしたか。</p>";

scale[5]  = "フラストレーション"; 
left[5]   = "低い";
right[5]  = "高い";
def[5]    = "<p>体験中に、不安感、落胆、いらいら、ストレス、悩みをどの程度感じましたか。あるいは逆に、安心感、満足感、充足感、楽しさ、リラックスをどの程度感じましたか。</p>";
